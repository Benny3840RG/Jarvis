...
- Re-verified locally after the fix: fresh `npm run check` — 598 tests, 0 failures, type-check/lint/format/OpenAPI-lint all clean. Permanent CI run on this new exact head is pending as of this report; will be confirmed before this task is treated as closed out.
