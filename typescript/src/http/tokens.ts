...
export const HTTP_BUSINESS_SETTINGS_STORE = Symbol("HTTP_BUSINESS_SETTINGS_STORE");
export const HTTP_ENQUIRY_STORE = Symbol("HTTP_ENQUIRY_STORE");
export const HTTP_INVOICE_STORE = Symbol("HTTP_INVOICE_STORE");
export const HTTP_CLIENT_STORE = Symbol("HTTP_CLIENT_STORE");
export const HTTP_PROPERTY_STORE = Symbol("HTTP_PROPERTY_STORE");
...
export const HTTP_DEVELOPMENT_LIVE_WORK = Symbol("HTTP_DEVELOPMENT_LIVE_WORK");
export const HTTP_DANGER_ZONE = Symbol("HTTP_DANGER_ZONE");
