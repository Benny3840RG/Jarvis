...
| R-091–R-098C | `safetyCategoryMatrix.test.ts`, `convex/orchestrationState.test.ts`, `tests/orchestrationDurability.test.ts` | `src/safety/safetyBinder.ts`, `convex/orchestrationState.ts`, `src/orchestration/runner.ts`, exact PR #329 workflow #1413 (31256419743), PR #336 workflow #1440 (31257990451), PR #344 workflow #1446 (31258557727) | Partial |
| R-099–R-104 | `convex/orchestrationState.test.ts`, `convex/externalReconciliations.test.ts`, `tests/orchestrationDurability.test.ts` | `convex/orchestrationState.ts`, `convex/externalReconciliations.ts`, `src/orchestration/runner.ts`; provider-authenticated offline recovery and the #344 lease-boundary repair are verified, while live restart drills remain open | Partial |
| R-105–R-111 | `safetyBinder.test.ts`, `safetyCategoryMatrix.test.ts`, `convex/toolActions.test.ts`, `convex/toolExecutionReceiptMetadata.test.ts`, `convex/externalReconciliations.test.ts`, `convex/orchestrationState.test.ts` | `convex/safetyBindingValidators.ts`, `convex/schema.ts`, `convex/toolActions.ts`, `convex/toolExecutionReceipts.ts`, `convex/externalReconciliations.ts`, `convex/orchestrationState.ts`; PR #336 workflow #1440 (31257990451) and Copilot Check (31257990434) | Partial |
...
The tests prove the six-category in-process contract, fail-closed negative paths, lifecycle attachment, fresh Convex readback, durable runner composition, provider-authenticated offline recovery binding, and #344's lease-preserving durable failure boundary. They do not prove authenticated worker identity, real ingress, deployed restart behavior, or live external commissioning. Status remains partial until those gates are separately evidenced.
