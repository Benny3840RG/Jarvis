# Claude continuous-work handover

Use this handover when starting or resuming Claude work on Jarvis.
...
The coordination protocol is mandatory. It prevents Claude and Codex from
...
If Claude is not explicitly named as the current builder or reviewer, perform no
repository write.
...
11. Hand Codex the exact candidate SHA and the complete builder handoff from the
...
1. Wait for Codex's exact candidate SHA and complete builder handoff.
