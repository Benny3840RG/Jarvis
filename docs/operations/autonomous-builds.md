...
Approved autonomous output is opened as a draft pull request. Owner review and merge remain mandatory, and commissioning and deployment are never automatic.
