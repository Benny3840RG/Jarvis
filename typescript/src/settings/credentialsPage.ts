...
<body>
  <main>
    ...
    <section class="card" id="approval">
      <h2>Approval token</h2>
      <p class="status">CLI only. This card does not confirm or remove the previous approval token.</p>
      <p><a class="link" href="/settings/credentials">Back to Credentials</a></p>
    </section>
    <section class="card" id="delivery">
      <h2>Delivery runtime token</h2>
      <p class="status">CLI only. This card does not confirm or remove the previous delivery token.</p>
